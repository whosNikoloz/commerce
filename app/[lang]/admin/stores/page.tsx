...
export async function generateMetadata(
  ...
  return i18nPageMetadataAsync({
    title: dict.pages.admin.stores.title,
    description: dict.pages.admin.stores.description,
    lang,
    path: "/admin/stores",
  ...
  return (
    <div className="space-y-8">
      <div className="space-y-2">
        <h1 className="font-heading text-4xl md:text-5xl font-black tracking-tight bg-gradient-to-r from-slate-900 via-blue-900 to-cyan-900 dark:from-slate-100 dark:via-blue-100 dark:to-cyan-100 bg-clip-text text-transparent">
          {dict.pages.admin.stores.heading}
        </h1>
        <p className="font-primary text-slate-600 dark:text-slate-400 text-lg font-medium">
          {dict.pages.admin.stores.subtitle}
        </p>
      </div>
            ...
            <div className="animate-pulse space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                {[...Array(6)].map((_, i) => (
                  <div
                    key={i}
                    className="h-32 bg-gray-300/20 dark:bg-gray-700/20 rounded"
                  />
                ))}
              </div>
            </div>
