...
//           <h2 className="font-heading mb-1 text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white">
...
//                   }}
//                 >
//                   <span className="font-primary text-yellow-500">
...
export default function resepassPage() {
