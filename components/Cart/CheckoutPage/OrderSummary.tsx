...
export default function OrderSummary({
  ...
  return (
    <Card className="sticky top-8 h-min dark:bg-brand-muteddark bg-brand-muted">
      <CardHeader>
      ...
      <CardContent className="space-y-4">
        ...
        {/* NOTE: the submit button now sits in the form on the left. We keep a "security" block here */}
        ...
        {/* Optional second button on the summary card (disabled here) */}
