  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Hat trim (white fur) */}
        <ellipse cx="50" cy="65" fill="#FFFFFF" rx="32" ry="6" />
        <ellipse cx="50" cy="64" fill="#F3F4F6" rx="32" ry="5" />

        {/* Pom-pom at top */}
        <circle cx="50" cy="12" fill="#FFFFFF" r="8" />
        <circle cx="50" cy="12" fill="#F9FAFB" r="7" />
        <circle cx="48" cy="10" fill="#E5E7EB" opacity="0.6" r="2" />
        <circle cx="53" cy="13" fill="#E5E7EB" opacity="0.6" r="1.5" />
