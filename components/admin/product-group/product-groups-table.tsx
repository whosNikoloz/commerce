            ...
            <CardHeader className="pb-4 relative">
              <div className="flex flex-col gap-3 md:gap-4 md:flex-row md:items-center md:justify-between">
                <div className="flex items-center gap-2 flex-1">
                  <Button
                    className="shrink-0 bg-blue-500 text-white shadow-lg"
                    size="sm"
                  ...
                  <div className="relative flex-1">
                    ...
                    <Input
                      ...
                      className="pl-10 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border-2 border-slate-200 dark:border-slate-700 focus:border-blue-400 dark:focus:border-blue-600 text-slate-900 dark:text-slate-100 placeholder:text-slate-500 dark:placeholder:text-slate-400 font-medium shadow-sm"
                  ...
                  <>
                    ...
                    <div className="md:hidden space-y-4 p-4">
                      {filteredGroups.map((group) => (
                        <Card
                          key={group.id}
                          className="group hover:shadow-2xl transition-all duration-300 bg-white/90 dark:bg-slate-900/90 border-2 border-slate-200 dark:border-slate-800 hover:border-blue-300 dark:hover:border-blue-700"
                        >
                          <CardContent className="p-4 space-y-3">
                            ...
                            <div className="flex gap-2 pt-2">
                              ...
                              <Button
                                className="flex-1 border-blue-200 dark:border-blue-800 text-blue-700 dark:text-blue-300 hover:bg-blue-50 dark:hover:bg-blue-900/20"
                                size="sm"
                                variant="outline"
                                onClick={() => handleEdit(group)}
                              >
