  ...
  return (
    <>
      <button
        ...
        className="p-2 bg-gradient-to-r from-blue-500 to-indigo-600 dark:from-blue-600 dark:to-indigo-700 text-white rounded-full shadow-lg hover:scale-105 transition-transform relative"
        onClick={openCart}
      >
        🛒 Cart
        {cart.length > 0 && (
          <span className="absolute -top-2 -right-2 bg-red-600 dark:bg-red-500 text-white text-xs rounded-full px-2 shadow-md">
