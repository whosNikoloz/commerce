...
export default function Footer() {
  ...
  const t = {
    information: dictionary?.footer?.information,
    delivery: dictionary?.footer?.delivery,
    faq: dictionary?.footer?.faq,
    guarantee: dictionary?.footer?.guarantee,
    privacy: dictionary?.footer?.privacy,
    returns: dictionary?.footer?.returns,
    stores: dictionary?.footer?.stores,
    terms: dictionary?.footer?.terms,
    about: dictionary?.footer?.about,
    help: dictionary?.footer?.help,
    language: dictionary?.footer?.language,
    location: dictionary?.footer?.location,
    visitStores: dictionary?.footer?.visitStores,
    address: dictionary?.footer?.address,
    hours: dictionary?.footer?.hours,
